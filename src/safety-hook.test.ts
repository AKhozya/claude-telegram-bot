...
test(
  "a process that never finishes denies once the deadline passes, and a kill is requested",
  async () => {
...
test(
  "returns even when a grandchild holds the pipes open",
  async () => {
